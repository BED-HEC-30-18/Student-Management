...
class LikeButtonEdit extends StatefulWidget {
  const LikeButtonEdit({
    Key? key,
  ...
  /// call back of first frame with LikeButtonEditState
  final Function(LikeButtonEditState state)? postFrameCallback;

  @override
  State<StatefulWidget> createState() => LikeButtonEditState();
}

class LikeButtonEditState extends State<LikeButtonEdit>
  ...
  @override
  void didUpdateWidget(LikeButtonEdit oldWidget) {
    _isLiked = widget.isLiked;
    _likeCount = widget.likeCount;
    _preLikeCount = _likeCount;
